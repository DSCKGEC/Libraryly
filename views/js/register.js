...
function toggle_status(id_element,change_to)
{
    ...
    if(change_to==0)//correct
    {
        document.querySelector("#"+id_element).style.border="1px solid #5bdb95";
        document.querySelector("#"+id_element+"-correct").className="tooltip-right correct";
        document.querySelector("#"+id_element+"-wrong").className="tooltip-right nothing";
    }
    else if(change_to==1)//wrong
    {
        document.querySelector("#"+id_element).style.border="1px solid red";
        document.querySelector("#"+id_element+"-correct").className="tooltip-right nothing";
        document.querySelector("#"+id_element+"-wrong").className="tooltip-right error";
    }
    else//neutral
    {
...
function checkpass()
{
    ...
    else
    {
        ...
        set_tooltip("password-wrong","Password should be between 8-15 characters and contain at least one lowercase letter, one uppercase letter, one numeric digit, and one special character");
    }
}
